            ...
            <form action="${pageContext.request.contextPath}/admin" method="post" id="formCliente" onsubmit="return validarFormulario(event)">
                ...
                <div class="form-row">
                    <div class="form-grupo">
                        ...
                        <input type="text" name="nombres" class="form-control" required
                               ...
                               maxlength="50" onkeydown="bloquearTecladoNumerico(event)">
                    </div>
                    <div class="form-grupo">
                ...
                <div class="form-grupo">
                    ...
                    <input type="email" name="correo" id="correo" class="form-control"
                           placeholder="correo@ejemplo.com" value="<%= valCorreo%>" maxlength="100"
                ...
                <div class="form-grupo">
                    ...
                    <input type="text" name="direccion" class="form-control"
                           placeholder="Calle, número, ciudad" value="<%= valDireccion%>" maxlength="100">
                </div>
