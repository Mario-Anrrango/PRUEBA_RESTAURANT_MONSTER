...
<div class="contenedor" style="margin-top:25px;">
    ...
    <form action="${pageContext.request.contextPath}/empleado" method="post" class="busqueda-form">
        ...
        <div class="form-grupo">
            ...
            <input type="text" name="cedula" class="form-control"
                   placeholder="Ingrese cédula o identificación" required autofocus>
        </div>
    ...
    <div style="background:#fef9f1;border:1px solid var(--borde);border-radius:12px;padding:20px;margin-top:10px;">
        ...
        <table class="tabla" style="margin-top:0;">
            <tbody>
                <tr>
                    ...
                    <td><strong>Cédula:</strong></td><td><%= clienteEncontrado.getCedula() != null ? clienteEncontrado.getCedula() : clienteEncontrado.getIdentificacionExtranjera() %></td>
                </tr>
                <tr>
        ...
        <h4 style="font-family:'Playfair Display',serif;color:var(--marron);margin:20px 0 10px;">Historial de Pedidos</h4>
        <table class="tabla">
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <% if ("PENDIENTE".equals(p.getEstado())) { %>
                            <a href="${pageContext.request.contextPath}/empleado/tomar-pedido?idCliente=<%= clienteEncontrado.getId() %>&modificar=<%= p.getId() %>"
                               class="btn btn-sm btn-exito">✏️ Editar</a>
                        <% } else { %>
